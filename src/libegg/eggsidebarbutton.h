...
#define EGG_SIDEBAR_BUTTON(o)                                                                      \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EGG_TYPE_SIDEBAR_BUTTON, EggSidebarButton))
#define RB_SIDEBAR_BUTTON_CLASS(k)                                                                 \
  (G_TYPE_CHECK_CLASS_CAST((k), EGG_TYPE_SIDEBAR_BUTTON, EggSidebarButtonClass))
...
#define EGG_SIDEBAR_BUTTON_GET_CLASS(o)                                                            \
  (G_TYPE_INSTANCE_GET_CLASS((o), EGG_TYPE_SIDEBAR_BUTTON, EggSidebarButtonClass))
